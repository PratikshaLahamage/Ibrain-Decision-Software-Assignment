<%-- 
    Document   : index
    Created on : May 12, 2021, 7:52:29 PM
    Author     : DELL
--%>
...
<td style="width:100px"><b>Month</b></td>  
     ...
     Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
            ...
            String q="select clinicid,count(*),SUBSTRING(apptdate,4) as Month from appointmentinfo group by clinicid,SUBSTRING(apptdate,4)";
